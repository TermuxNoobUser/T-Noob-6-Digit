...
\033[0;94m  _____     _   _  ___   ___  ____ 

\033[0;94m  |_   _|   | \ | |/ _ \ / _ \| __ ) 

\033[0;96m     | |___|  \| | | | | | | |  _ \ 

\033[0;96m     | |___| |\  | |_| | |_| | |_) |

\033[0;96m     | |      | | \_|\___/ \___/|____/ 

""")

print("\033[0;91mThis Tool's Free By TERMUX NOOB")
...
def menu():
    ...
    print '\033[0;93mAUTHOR   : TERMUX NOOB USER'

    print '\033[0;94mFACEBOOK : TERMUX NOOB USER'

    print '\033[0;96mGITHUB   : TermuxNoobUser'
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[T-NOOB-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;91m[T-NOOB-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
    ...
    '[\xe2\x9c\x93] T-NOOB OK/CP : ' + str(len(oks)) + '/' + str(len(cpb))

    print '[\xe2\x9c\x93] CP File Has Been Saved : save/checkpoint.txt'

    raw_input('\n[Press Enter To Go Back]')

    os.system('python2 T-Noob-6-Digit.py')
